...
import 'package:flutter_movie_list/onnx/embedding.dart';
...
class WordpieceTokenizer {
  ...
  List<TextAndTokens> _createSubstrings(String text, {int? maxTokens}) {
    ...
    var allOutputTokens = <List<int>>[];
    var allOutputStrings = <String>[];
    var words = text.split(RegExp(r'\s+')); // Split on whitespace

    var outputTokens = <int>[startToken];
  ...
  String detokenize(List<int> tokens) {
    ...
    var processedFirstNonstartToken = false;
